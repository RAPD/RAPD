...
class DiffCenterAction:
    ...
    def __init__(self,fullname,server,port,logger):
        logger.info('DiffCenterAction::__init__')
    ...
    def run(self):
        try:
            self.logger.debug('DiffCenterAction::run')
            self.queryServer()
            self.parseResults()
            #print self.output
        except:
...
class DiffractionCenter(multiprocessing.Process,Communicate):
    """
    ...
    def __init__(self,input,logger=None,verbose=True):       
        """
        Initialize the AutoindexingStrategy process
        ...
        multiprocessing.Process.__init__(self,name='DiffractionCenter')        
    ...
    def run(self):
        ...
        """
        self.logger.debug('DiffractionCenter::run')                    
        self.preprocess()
    ...
    def preprocess(self):
        ...
        """       
        self.logger.debug('DiffractionCenter::preprocess')
    ...
    def preprocessMultiDistl(self):
        ...
        """
        self.logger.debug('DiffractionCenter::preprocessMultiDistl')
        try:            
            distl_input  = []
    ...
    def multiDistl(self):
        ...
        """
        self.logger.debug('DiffractionCenter::multiDistl')
    ...
    def postprocess(self):
        ...
        """
        self.logger.debug('DiffractionCenter::postprocess')
...
if __name__ == '__main__':
    ...
    LOG_FILENAME = '/tmp/rapd_agent_diffcenter.log'
    ...
    logger.info('DiffractionCenter.__init__')    
        
    #call the handler
    #T = TestHandler(input, logger=logger)
    D = DiffCenterAction('./test_data/raster_snap_test_1_001.img','my_server',8125,logger)
    print D.output 
