...
if __name__ == "__main__":
    ...
    def sortTask(data):
        print "1-- SortTask starting for ", data
    ...
    def waitTask(data):
        print "2-- WaitTask sleeping for %d seconds" % data
        sleep(data)
        return "<== Waiter", data
    ...
    pool.queueTask(sortTask, (1000, 1000000), taskCallback)
    pool.queueTask(waitTask, 4, taskCallback)
    pool.queueTask(sortTask, (200, 2000000), taskCallback)
    pool.queueTask(waitTask, 5, taskCallback)
    pool.queueTask(sortTask, (3, 300000), taskCallback)
    pool.queueTask(waitTask, 6, taskCallback)
