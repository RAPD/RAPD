...
LOGFILE_DIR = "/tmp/rapd2/log/"
LOG_LEVEL = 50

################ Directories ################
# Where files are exchanged between plugins and control
EXCHANGE_DIR = "/tmp/rapd2/exchange_dir"
...
# rapd.python path
RAPD_PYTHON_PATH = "/Users/fmurphy/workspace/rapd/bin/rapd.python"
...
DETECTOR_SUFFIX = ".cbf"
# Keyed to ID
DETECTORS = {"KOHALA": ("NECAT_DECTRIS_PILATUS6MF", ""),
...
# file name prefix for adapter in src/
REMOTE_ADAPTER = "sites.site_adapters.necat_remote"
