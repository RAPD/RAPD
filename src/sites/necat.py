...
REQUEST_MONITOR = "monitors.request_moniitors.redis_request_monitor"
# Pause between checking the database for new cloud requests in seconds
REQUEST_INTERVAL = 1
# Directories to look for cloud handlers
# REQUEST_HANDLER_DIRECTORIES = ("request.handlers", )
# Request handlers
# REQUEST_DATAPRODUCED = "data_produced"
# REQUEST_MINIKAPPA_HANDLER = None
# REQUEST_DATA_COLLECTION_PARAMS = False
# REQUEST_DATA_COLLECTION_PARAMS_HANDLER = "datacollectionparameters"
# REQUEST_DOWNLOAD_HANDLER = "download"
# REQUEST_BINARY_MERGE_HANDLER = "binary_merge"
# REQUEST_MR_HANDLER = "mr"
# REQUEST_REINDEX_HANDLER = "reindex"
# REQUEST_REINTEGRATE_HANDLER = "reintegrate"
