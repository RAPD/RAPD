...
ID = "8d35a5421b0b11e7b685ac87a3333966"
VERSION = "1.0.0"
...
class RapdPlugin(multiprocessing.Process):
    ...
    def __init__(self, site, command, tprint=False, logger=False):
        ...
        multiprocessing.Process.__init__(self, name="test_plugin")
        self.start()
...
def get_commandline():
    ...
    commandline_description = "Test test_plugin plugin"
