"""Wrapper for launching test_plugin"""
...
# import utils
import utils.log
import utils.modules import load_module
...
def get_commandline():
    ...
    commandline_description = "Launch test_plugin plugin"
...
def main():
    ...
    plugin = load_module(seek_module="plugin",
                         directories=["plugins.test_plugin"],
                         logger=logger)
