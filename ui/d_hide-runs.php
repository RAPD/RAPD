<?php 
  ...
  $sql        = "UPDATE results r RIGHT JOIN integrate_results i ON r.id=i.integrate_result_id SET r.display='hide' WHERE r.data_root_dir='$datadir' AND r.type='integrate' AND i.integrate_status!='SUCCESS'";
