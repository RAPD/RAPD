...
<? 
    if (allow_access(Administrators) == "yes")
    {
        ...
        echo('      </td>');
        echo('      <td>');
        echo('        <a class="button" href="./graphs/index.php" onclick="this.blur(); return true;"><span>Data Stats</span></a>');
        echo('      </td>');
...
<?
    ...
    {   
        echo('      <td>');
        echo('        <a class="button" href="samples_main.php" onclick="this.blur(); return true;"><span>Samples</span></a>');
        echo('      </td>');
        echo('      <td>');
    ...
    if (allow_access(Administrators) == "yes")
    {
        ...
        echo('      <td></td>');
        echo('      <td align="center">');
        echo('        <a class="button" href="data_edevel.php" onclick="this.blur(); return true;"><span>Data - Extra-Development View</span></a>');
        echo('      </td>');
    }
