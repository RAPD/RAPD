<?php
  ...
  $beta              = $return2 -> beta;
  $gamma             = $return2 -> gamma;
  $user_dir_override = $return2 -> user_dir_override;
  $user_directory    = $return2 -> user_directory;
...
<html>
  ...
  <body>
  <div id="content">
  <form id='form-snap-reprocess' method="POST" action='./add_reprocess.php'>
...
?>
  ...
  <table>
    <tr>
      ...
      <td>
        <select name="user_dir_override">
<?
  if ($user_dir_override == 'True') {
...
?>
      ...
      <td>
        <input type="text" name="user_directory" value="<?echo $user_directory;?>" size=30>
      </td>
    </tr>
    <tr>
      <td align="right" width="175">
      ...
      <td>
        <select name="work_dir_override">
<?
  if ($work_dir_override == 'True') {
      echo("          <option value='True' selected='True'>True</option>\n");
      echo("          <option value='False'>False</option>\n");
    } else {
      echo("          <option value='True'>True</option>\n");
...
?>
      ...
      <td>
        <input type="text" name="work_directory" value="<?echo $work_directory;?>" size=30>
      </td>
    </tr>
  </table>
