...
if ($_POST[beamline] == "")
{
    echo "<P>Beamline is empty, please try again.</p>";
    echo "<P><a href=\"../../main.php\">Main Page</a></P>";
    echo "<P><a href=\"clients.php\">Back to clients</a></p>";
    echo "<P><a href=\"adminpage.php\">Back to the administrative control panel</a></p>";
    exit;
...
$sql ="SELECT * FROM authorized_clients WHERE client_ip='$_POST[client_ip]'";
...
if ($num != 0)
  {
      echo "<P>Sorry, that client is already assigned. If you wish to change the assignment, go back and delete it first.</P>";
      echo "<P><a href=\"../../main.php\">Main Page</a></P>";
      echo "<P><a href=\"clients.php\">Back to clients</a></p>";
      echo "<P><a href=\"adminpage.php\">Back to the administrative control panel</a></p>";
  }
  ...
  {
    //get the hostname by php
    $client_name = gethostbyaddr($_POST[client_ip]);

    $sql_add = "INSERT INTO authorized_clients (client_ip,client_name,beamline) VALUES ('$_POST[client_ip]','$client_name','$_POST[beamline]')";
    $result = @mysql_query($sql_add,$connection) or die(mysql_error());

    //close connection to the database
    mysql_close($connection);

    echo "<P>Client successfully added to database.</P>";
    echo "<P><a href=\"../../main.php\">Main Page</a></P>";
