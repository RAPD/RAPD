    ...
    $(document).ready(function(){
        ...
        $('#tabs0').tabs({remote:true,selected:0});
            ...
            //The Results Tab Set
            $("#tabs0-tab0-tabs1").tabs({remote:true,selected:0});
        ...
        $('#sad_menu').delegate('a','click',function(e){
            if( (!$.browser.msie && e.button == 0) || ($.browser.msie && e.button == 1) ) {
                //Mark the current click as being viewed and clear the rest
                $("#sad_menu").find('a').removeClass("clicked");
                $(this).addClass("clicked");
                //Load the data
        ...
        $('#button_global_settings').click(function(){
            ...
            $("#dialog-generic").load("d_global_settings.php",
                {datadir:my_datadir,
                 beamline:my_beamline},
                function(response, status, xhr) {
                    $(this).dialog( "option", "title", "Global Settings");
                    $("#dialog-generic").dialog("option","width",400);
                    $("#dialog-generic").dialog("option","height",650);
                    $(this).dialog("option", "buttons", {
                        'Submit': function() {
                            //alert($('#form-global-settings').serialize());
                            $.ajax({
                                type:"POST",
                                url:"d_add_settings.php",
                                data:$('#form-global-settings').serialize(),
                                success:function(){
                                    $("#dialog-generic").dialog("close");
        ...
        $('#puck-dialog').click(function() {
            $("#dialog-generic").dialog( "option", "title", "Assign Pucks" );
            $("#dialog-generic").dialog( "option", "width", 700 );
            $("#dialog-generic").dialog( "option", "height", 400 );
            $("#dialog-generic").load("puck_settings.php", {beamline:my_beamline,
                                                            username:my_user,
                                                            datadir:my_datadir});
            $("#dialog-generic").dialog("option", "buttons", {
                'OK': function() {
                                  var form = $('#SelectPuck');
        ...
        $('#runs-sort-table tbody').click(function(event) {
            ...
            $("#snap_menu").children('.clicked').removeClass("clicked");
            $("#run_menu").children('.clicked').removeClass("clicked");
            $('#run_menu, #'+res_id).addClass("clicked");
            //Load the data
                        ...
                        if ($(context).attr('id') > 0)
                        {
                            switch($(this).attr('id'))
                            {
                                ...
                                case 'hide-all-snaps':
                                    ...
                                    $.get('d_hide-snaps.php',{datadir : my_datadir });
                                    //
                                    break;
                                ...
                                case 'hide-all':
                                    ...
                                    //Change the database entries  for display as hidden
                                    $.get('d_hide-snaps.php',{datadir : my_datadir });
                                    $.get('d_hide-runs.php',{datadir : my_datadir });
                                    //
                                    break;
                                ...
                                case 'snap_settings':
                                    //new-style modal dialog
                                    $("#dialog-generic").load("d_snap_settings.php",
                                ...
                                case 'snap_header':
                                    //new-style modal dialog
                                    $("#dialog-generic").load("d_header.php",
                                        {result_id:$(context).attr('id'),
                                         start_repr:$(context).text()},
                                        function(response, status, xhr) {
                                            $(this).dialog( "option", "title", $(context).text());
                                            $(this).dialog("option", "buttons", {});
                                            $("#dialog-generic").dialog("option","width",500);
                                            $("#dialog-generic").dialog("option","height",650);
                                            $(this).dialog('open');
                                        }
                                    );
                                ...
                                case 'snap_reprocess':
                                    if (cloud_process == '1')
                                    {
                                        ...
                                        $("#dialog-generic").dialog( "option", "title", 'Reprocess '+$(context).text());
                                        $("#dialog-generic").dialog( "option", "modal", true );
                                        $("#dialog-generic").dialog( "option", "width", 460 );
                                        $("#dialog-generic").dialog( "option", "height", 530 );
                                        $("#dialog-generic").load("d_snap_reprocess.php", {result_id:$(context).attr('id'),
                                                                                         start_repr:$(context).text(),
                                                                                         type:'reprocess',
                                                                                         ip:my_ip,
                                                                                         datadir:my_datadir});
                                ...
                                case 'snap_kappa':
                                    ...
                                    {   
                                        //new-style modal dialog
                                        $("#dialog-generic").load("d_snap_kappa.php",
                                            {result_id:$(context).attr('id'),
                                             start_repr:$(context).text(),
                                             type:'stac',
                                             ip:my_ip},
                                            function(response, status, xhr) {
                                                ...
                                                $("#dialog-generic").dialog("option","width",300);
                                                $("#dialog-generic").dialog("option","height",250);
                                                $(this).dialog("option", "buttons", {
                                                    'Run': function() {
                        ...
                        if ($(context).attr('id'))
                        {
                            switch($(this).attr('id'))
                            {
                                ...
                                case 'run-xia2':
                                    ...
                                    $("#dialog-generic").dialog( "option", "title", 'Integrate and Scale '+$(context).text()+' Using Xia2');
                                    $("#dialog-generic").dialog( "option", "modal", true );
                                    $("#dialog-generic").dialog( "option", "width", 500 );
                                    $("#dialog-generic").dialog( "option", "height", 200 );
                                    $("#dialog-generic").load("d_run_integrate.php", {result_id:$(context).attr('id'),
                                                                                      start_repr:$(context).text(),
                                                                                      type:'start-xiaint',
                                                                                      ip:my_ip,
                                                                                      datadir:my_datadir});
                                ...
                                case 'run-integrate':
                                    //popup a dialog with the processing options
                                    $("#dialog-generic").dialog( "option", "title", 'Integrate and Scale '+$(context).text()+' Using RAPD Pipeline');
                                    $("#dialog-generic").dialog( "option", "modal", true );
                                    $("#dialog-generic").dialog( "option", "width", 500 );
                                    $("#dialog-generic").dialog( "option", "height", 200 );
                                    $("#dialog-generic").load("d_run_integrate.php", {result_id:$(context).attr('id'),
                                ...
                                case 'start-sad':
                                    ...
                                    //popup a dialog with the reprocessing options
                                    //Set properties of the dialog
                                    $("#dialog-generic").dialog( "option", "title", 'Initiate SAD Structure Solution on '+$(context).text());
                                    $("#dialog-generic").dialog( "option", "modal", true );
                                    $("#dialog-generic").dialog( "option", "width", 500 );
                                    $("#dialog-generic").dialog( "option", "height", 400 );
                                    $("#dialog-generic").load("d_run_sad.php", {result_id:$(context).attr('id'),
                                                                                start_repr:$(context).text(),
                                                                                type:'start-sad',
                                                                                ip:my_ip,
                                                                                datadir:my_datadir});
                                ...
                                case 'start-mr':
                                    //alert("MR");
                                    //Set properties of the dialog
                                    $("#dialog-generic").dialog( "option", "title", 'Initiate Molecular Replacement on '+$(context).text());
                                    $("#dialog-generic").dialog( "option", "modal", true );
                                    $("#dialog-generic").dialog( "option", "width", 500 );
                                    $("#dialog-generic").dialog( "option", "height", 250 );
                                    $("#dialog-generic").load("d_run_mr.php", {result_id:$(context).attr('id'),
                                                                               start_repr:$(context).text(),
                                                                               type:'start-mr',
                                                                               ip:my_ip,
                                                                               user:my_user,
                                                  ...
                                                  else
						  {
					        ...
					        alert(e);
                                ...
                                case 'simple-merge':
                                   if (cloud_process == '1')
                                   {
                                       tb_show("Merging "+$(context).text(),"d_merge.php?height=150&width=570&result_id="+$(context).attr('id')+"&start_repr="+$(context).text()+"&type=smerge&ip="+my_ip);
                                   } else {
                                       alert('Sorry - processing not currently enabled');
                                   }
        ...
        $('#sad_menu > a.working').jeegoocontext('sadmenu-working', {
                    livequery: true,
                    widthOverflowOffset: 0,
                    heightOverflowOffset: 1,
                    submenuLeftOffset: -4,
            ...
            if(json.length)
            {
                for(i=0; i < json.length-1; i=i+7)
                {
                    ...
                    else if (json[i] == "run")
                    {
                        ...
                        {
                            $("#run_menu_in_process").children('.in_process_'+json[2]).hide('slow');
                        }
    ...
    function cloudMonitor() {
        ...
        $.getJSON("d_get_cloud.php?datadir="+my_datadir+"&user="+my_user+"&trip_id="+my_trip_id+"&ip_address="+my_ip+"&id="+lastcloudID, function(json) {
            ...
            {
                var my_timeout_id = setTimeout(cloudMonitor, 60000);
            }
        });
    };
      ...
      $.getJSON("d_get_result_data.php?res_id="+my_res_id+"&datadir="+my_datadir+"&trip_id="+my_trip_id, function(json) {
        if (json.length) {
          if (json[2] == 'None')
          {
            ...
            // Samples Tab
            $("#tabs0-tab0-tabs1-tab7").css("display","list-item");
          }
          else
          {
            ...
            $("#tabs0-tab0-tabs1-0").css("display","none");
            $("#tabs0-tab0-tabs1-2").css("display","none");
            $("#tabs0-tab0-tabs1-3").css("display","none");
            $("#tabs0-tab0-tabs1-4").css("display","none");  
          }
        }   
      });
    };
        ...
        $.getJSON("d_get_result_data.php?res_id="+my_res_id+"&datadir="+my_datadir+"&trip_id="+my_trip_id, function(json) {
            if (json.length) { 
                ...
                if (my_version < json[7])
                {
                    ...
                    // Summary tab 
                    $("#tabs0-tab0-tabs1-0").css("display","list-item");
                    $("#summary").delay(500).empty().load(json[1], 
                    ...
                    $("#stac-summary").empty();
                    $("#tabs0-tab0-tabs1-1").css("display","none");
                    // Details tab 
                    ...
                    //Load samples
                    $("#tabs0-tab0-tabs1-7").css("display","list-item");
