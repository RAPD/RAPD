...
//build and issue the query
  if ( $sample_id != ""  ) {
     $sql ="SELECT result_id,type,id FROM results WHERE sample_id LIKE '%$sample_id' ORDER BY result_id";
  } elseif ( $datadir != "") {
     $sql ="SELECT result_id,type,id FROM results WHERE data_root_dir LIKE '%$datadir' ORDER BY result_id";
  } else {
     $sql ="SELECT result_id,type,id FROM results WHERE sample_id LIKE '%$sample_id' ORDER BY result_id";
  }
