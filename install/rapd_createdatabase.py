...
"""
Should create a MySQL database in the correct configuration 
for getting RAPD up

Untested as of 11/21/2011, but should be very close to the
real thing.
"""
...
if __name__ == '__main__':
    """
    Take inputs and create the databases
    """
    
    print 'rapd_makedatabase.py'
    print '===================='
